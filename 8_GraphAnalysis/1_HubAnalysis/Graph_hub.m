...
function Graph = Graph_hub(TCM_bin, TCM,color_funct_links,size_link,size_arrow,degree_nodes,type_hub)
...
for j = 1: length(x1x2)
    ...
    elseif sum(ismember(Gray,xy(find(xy(:,1)==x1x2(j,1) & xy(:,2)==y1y2(j,1)),3)))==1
        plot(x1x2(j,:)',y1y2(j,:)','Color', [0.8 0.8 0.8],'LineWidth',size_link);
...
if length(Net)==120
    ...
    for neuron = 4:l-3
        if tmp(count)==1
            text(neuron,12, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,12, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
    ...
    for neuron = 3:l-2
          if tmp(count)==1
            text(neuron,11, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,11, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
    ...
    for neuron = 2:l-1
        if tmp(count)==1
            text(neuron,10, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,10, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
    ...
    for neuron2 = 9:-1:4
        for neuron = 1:l
            if tmp(count)==1
                text(neuron,neuron2, 'Exc','FontWeight','bold','HorizontalAlignment','center')
            elseif tmp(count) == -1
                text(neuron,neuron2, 'Inh','FontWeight','bold','HorizontalAlignment','center')
            elseif tmp(count)==2
    ...
    for neuron = 2:l-1
        if tmp(count)==1
            text(neuron,3, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,3, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
    ...
    for neuron = 3:l-2
      if tmp(count)==1
            text(neuron,2, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,2, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
    ...
    for neuron = 4:l-3
      if tmp(count)==1
            text(neuron,1, 'Exc','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count) == -1
            text(neuron,1, 'Inh','FontWeight','bold','HorizontalAlignment','center')
        elseif tmp(count)==2
