...
% 	 arrowh(x1,x2,'r',[],20);            % passing on entire vectors
% 	 arrowh([0 1],[0 1],'eb',[300,75]);  % passing on 2 points

%	 Author:     Florian Knorn
%	 Email:      florian@knorn.org
%	 Version:    1.12
%	 Filedate:   May 19th, 2006
%
%	 History:    1.13 - Allow for non-solid arrow heads
